function [genes,header,gene_entry] = getgeneinfo_WormBase(filename_local,gene_entry)
...
%
% INPUT:
% filename: provide the location of the file on disk (optional)
...
if nargin < 1 % this if loop goes to the ftp site and downloads the file and data
